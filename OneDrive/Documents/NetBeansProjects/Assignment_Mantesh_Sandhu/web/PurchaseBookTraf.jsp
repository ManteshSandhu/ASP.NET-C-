<%-- 
    Document   : PurchaseBookTraf
    Created on : 30-Nov-2019, 7:43:20 PM
    Author     : SandhuM
--%>
...
<html>
    <head>
        ...
        <title>Trafalgar BookStore</title>
    </head>
    <body id="back">
        <div id="header">
            <h3>Welcome to Trafalgar Campus BookStore</h3>
        ...
        <hr>
            ...
            <c:choose> 
                ...
                <form action="CompletePurchaseTraf" method="POST">
                    <table border="1">
            ...
            <br><br>
        <div>
            <button onclick="window.location.href ='PurchaseBookTraf.html';" >
                Go Back
            </button><br><br>
