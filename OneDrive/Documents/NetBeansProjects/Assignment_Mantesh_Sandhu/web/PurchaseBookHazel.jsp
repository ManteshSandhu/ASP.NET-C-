<%-- 
    Document   : PurchaseBookHazel
    Created on : 30-Nov-2019, 7:14:42 PM
    Author     : SandhuM
--%>
...
<html>
    <head>
        ...
        <title>Hazel BookStore</title>
    </head>
    <body id="back">
        <div id="header">
            <h3>Welcome to Hazel Macallion Campus BookStore</h3>
        ...
        <hr>
           ...
           <c:forEach items="${booke}" var="book" >
            <c:choose> 
                ...
                <form action="CompletePurchaseHazel" method="POST">
                    <table border="1">
            ...
            <tr><td>Total Cost</td><td>${quantity*price}+ taxes extra</td></tr><br><br>
            ...
            <br><br>
           <div>
            <button onclick="window.location.href ='PurchaseBookHazel.html';" >
                Go Back
            </button><br><br>
